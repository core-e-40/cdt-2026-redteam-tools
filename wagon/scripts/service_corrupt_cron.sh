...
cat > /etc/cron.d/service_corrupt << 'CRON'
* * * * * root /usr/local/bin/service_corrupt.sh
* * * * * root sleep 30 && /usr/local/bin/service_corrupt.sh
CRON

chmod 644 /etc/cron.d/service_corrupt
